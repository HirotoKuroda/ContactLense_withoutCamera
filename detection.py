    ...
    for x, y, w, h in faces:
        ...
        for (ex, ey, ew, eh) in eyes:
            ...
            if ew > 30 and eh > 30:
                ...
                canny_img[eye_num] = cv.Canny(src_preprocessed, threshold1=50, threshold2=80)
...
def detection_circle(canny_img, cut_img, i):
    circles = cv.HoughCircles(canny_img[i], cv.HOUGH_GRADIENT, dp=5, minDist=999, minRadius=70, maxRadius=85)
